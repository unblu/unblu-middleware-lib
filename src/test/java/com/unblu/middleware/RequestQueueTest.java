...
import com.unblu.middleware.common.registry.RequestQueueErrorHandlerBootstrap;
...
class RequestQueueTest {
    ...
    void requestQueueCompletesOnShutdown() {
        var requestQueue = new RequestQueue(new FatalStartupErrorHandler(null), new ContextRegistryWrapper(new ContextRegistry()), new RequestQueueErrorHandlerBootstrap().testRequestQueueErrorHandler());
