...
public class ExternalMessengerContactsApiBeanCreator implements BeanCreator<Object> {
    ...
    public Object create(SyntheticCreationalContext<Object> ctx) {
        ...
        return creator.create("com.unblu.webapi.jersey.v4.api.ExternalMessengerContactsApi");
    }
}
